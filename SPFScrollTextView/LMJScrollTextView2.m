...
- (void)scrollWithNoSpaceByDirection:(NSNumber *)direction{
    ...
    // 处于当前页面
        ...
        [UIView animateWithDuration:ScrollItemTime delay:0.0 options:UIViewAnimationOptionCurveLinear|UIViewAnimationOptionAllowUserInteraction animations:^{
